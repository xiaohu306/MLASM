...
class CocoDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        vocab = self.vocab
        root, caption, img_id, path, image, region_feat= self.get_raw_item(index)
    ...
    def get_raw_item(self, index):
        ...
        return root, caption, img_id, path, image, region_feat
...
def collate_fn(data):
    ...
    images, region_feat, captions, ids, img_ids = zip(*data)
    ...
    return images,  region_feat,  targets, lengths, ids
